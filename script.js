...
const spaceTexture = loader.load('spacee.jpg');
...
//   wireframe: true,
// });
const torusTexture= loader.load('spacee.jpg');
...
const boxTexture = loader.load("logo.jpg");
...
const roopTexture = loader.load('test.jpg');
